...
function insertMessage($senderid,$sendername, $receiverid,$receivername, $text){

    $conn = getConnection();

    $sql = "INSERT INTO messages (sender_id,sender_name,  receiver_id,receiver_name, message_text, msg_status) VALUES ('$senderid', '$sendername', '$receiverid','$receivername', '$text', 'unread')";
    $stmt = $conn->prepare($sql);
    //$stmt->bind_param("iiss", $sender, $receiver, $text, "unread");
...
function updateMessage($id){
    ...
    if($id == ""){
        ...
        $sql = "UPDATE messages set msg_status = 'read' WHERE receiver_id = {$id}";
